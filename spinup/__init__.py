...
from spinup.algos.pytorch.stac.stac import stac as stac_pytorch
from spinup.algos.pytorch.stddpg.stddpg import stddpg as stddpg_pytorch
from spinup.algos.pytorch.stsac.stsac import stsac as stsac_pytorch
